    ...
    <main class="main-content">
        <div class="content-wrapper">
            ...
            <div class="actions-section">
                <a href="$gvPath/application/adminDeskEdit" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Ajouter un compteur
                </a>
                <a href="$gvPath/application/adminDeskEdit?pairing=1" class="btn btn-primary">
...
<tr>
    ...
    <td class="actions-cell">
        <a href="$gvPath/application/adminDeskEdit?desk_id=$id" class="action-btn edit" title="Modifier">

...
<div class="layout">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="$gvPath/application/adminDeviceList" class="nav-item active" title="Appareils"><i class="fas fa-mobile-alt"></i><span class="nav-text">Appareils</span></a>
...
document.getElementById('confirmDeleteBtn').addEventListener('click', () => {
    ...
    fetch(gvPath + '/ajax/removeRecord?dev_id=' + pendingDeleteId, {
        method: 'GET',
    ...
    .then(() => {
        ...
        closeDeleteModal();
        showToast('Appareil supprimé avec succès', 'success');
    })
...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .modal { background: #fff; border-radius: 20px; width: 100%; max-width: 520px; box-shadow: 0 24px 60px rgba(108,99,255,0.2); transform: translateY(20px) scale(0.97); transition: transform 0.3s; overflow: hidden; max-height: 90vh; overflow-y: auto; }
    ...
    .form-group input[type="text"] { width: 100%; padding: 11px 14px; border: 2px solid #eee; border-radius: 10px; font-size: 14px; color: #1a1a2e; font-family: inherit; transition: all 0.2s ease; outline: none; }

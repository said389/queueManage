...
<div class="layout">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="$gvPath/application/adminTopicalDomainList" class="nav-item active">
        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-folder-tree"></i>
                    <h3>Liste des domaines thématiques</h3>
                </div>
...
HTML;
    ...
    private function getTableBody() {
        ...
        if (!count($tds)) {
            return '<tr><td colspan="5" class="empty-row">Aucun domaine thématique disponible</td></tr>';
        }
